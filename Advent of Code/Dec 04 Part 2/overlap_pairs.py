...
def overlapping_pairs(pair_one, pair_two):
    ...
    if low_one >= low_two and low_one <= high_two:
        return 1
    elif high_one >= low_two and high_one <= high_two:
        return 1
    elif low_two >= low_one and low_two <= high_one:
        return 1
    elif high_two >= low_one and high_two <= high_one:
        return 1
    else:
        return 0
...
file_to_use = '/workspaces/codespaces-jupyter/Advent of Code/Dec 04 Part 2/pairings.txt'
pairing_list = []
matched_list = []
